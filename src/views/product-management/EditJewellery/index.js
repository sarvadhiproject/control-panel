...
const EditJewellery = ({ productId, allData, handleCancelEdit }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        gold_weight: allData?.gold_weight ? allData?.gold_weight : '',
        making_charges: allData?.making_charges ? allData?.making_charges : '',
        certification_file: allData?.certification_file
            ? allData?.certification_file
            : '',
        vendor_id: vendorID,
    })
