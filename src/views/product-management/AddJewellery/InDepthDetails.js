                ...
                <Col span={12}>
                    <Form.Item
                        ...
                        rules={[
                            {
                                required: true,
                                message: 'Product weight required.',
                                pattern: /^\d+(\.\d+)?$/,
                            },
                        ]}
                    ...
                    >
                        <Input
                            ...
                            type="number" // Changed to number to allow decimal input
                            step="0.01" // Allows decimal input with two decimal places
                        />
                    </Form.Item>
                </Col>
                <Col span={12}>
                            ...
                            },
                            {
                                validator: (_, value, callback) => {
                                    ...
                                    if (
                                        ...
                                        callback(
                                            'Gold weight must be less than or equal to product weight.'
                                        )
                                    } else {
                                        callback()
                                    }
